...
public class Dto_Select {
	// Field
		...
		public Dto_Select(String userId) {
			super();
			this.userId = userId;
		}
		
		public Dto_Select(String userId, String userName, String beforeUserAddress1, String beforeUserAddress2, String beforeUserAddress3, String beforeUserTel1, String beforeUserTel2, String beforeUserTel3) {
			super();
			this.userId = userId;
		...
		public Dto_Select(String userId, String userPw, String userName, String userAddress, String userTel, String userEmail, String userBirth) {
			super();
			this.userId = userId;
			this.userPw2 = userPw;
			this.userName = userName;
		...
		public Dto_Select(String userId, String userPw1, String userPw2, String userName,  String beforeUserAddress1, String beforeUserAddress2, String beforeUserAddress3, String beforeUserTel1, String beforeUserTel2, String beforeUserTel3, String beforeUserEmail1, String beforeUserEmail2, String userBirth) {
			super();
			this.userId = userId;
		...
		public Dto_Select(String userId, String userPw1, String userPw2, String userName, String userTel, String userAddress, String userEmail,
		...
		public void setIdCnt(int idCnt) {
			this.idCnt = idCnt;
			System.out.println("빈에 들어온 idCnt : " + idCnt);
		}
}
