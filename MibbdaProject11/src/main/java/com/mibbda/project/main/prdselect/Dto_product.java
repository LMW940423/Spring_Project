...
public class Dto_product {
	...
	public Dto_product(int prdNo, String ctgType, String prdName, int prdPrice, int prdStock, String prdFilename,
	...
	public Dto_product(int prdNo,String prdName, int prdPrice, String prdFilename) {
		super();
		this.prdNo = prdNo;
		this.prdName = prdName;
		this.prdPrice = prdPrice;
	...
	public Dto_product(int prdNo, String ctgType, String prdName,int prdPrice, String prdFilename, int prdStock) {
		super();
		this.prdNo = prdNo;
		this.ctgType = ctgType;
		this.prdName = prdName;
