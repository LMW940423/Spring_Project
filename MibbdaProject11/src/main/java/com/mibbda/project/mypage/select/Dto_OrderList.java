...
public class Dto_OrderList {
	...
	//생성자
	public Dto_OrderList() {
		
	}
	
	public Dto_OrderList(String ordNo, String prdName, int prdPrice, int ordQty, String ordDate,
	...
	public Dto_OrderList(int total) {
		super();
		this.total = total;
	}
