...
public class Store_Select_Store3Command implements Store_Select_Command {
	...
	public void execute(Model model) {
		...
		dtos = dao.storeList3(currentPage, pageSize);

		request.setAttribute("store3", dtos);  			
		
		System.out.println("store3 정보 : " + dtos.get(0).getCtgType());
		System.out.println("store3 정보 : " + dtos.get(0).getPrdContent());
		System.out.println("store3 정보 : " + dtos.get(0).getPrdDate());
		System.out.println("store3 정보 : " + dtos.get(0).getPrdName());

		//전체 글 갯수 구하기
		int totalRow = dao.getBoardCount_Store3();
