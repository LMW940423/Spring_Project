...
public class Store_Select_Store4Command implements Store_Select_Command {
	...
	public void execute(Model model) {
		...
		dtos = dao.storeList4(currentPage, pageSize);

		request.setAttribute("store4", dtos);  		
		
		System.out.println("store4 정보 : " + dtos.get(0).getCtgType());
		System.out.println("store4 정보 : " + dtos.get(0).getPrdContent());
		System.out.println("store4 정보 : " + dtos.get(0).getPrdDate());
		System.out.println("store4 정보 : " + dtos.get(0).getPrdName());

		//전체 글 갯수 구하기
		int totalRow = dao.getBoardCount_Store4();
